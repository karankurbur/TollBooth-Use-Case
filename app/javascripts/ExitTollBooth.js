...
// console.log(tollBoothContract.isPaused());
// console.log(tollBoothContract.hashSecret("ABC"));
 ...
 setOperatorContract : function() {
  ...
  exitTollBooth : function () {
    var unhashedSecret = document.getElementById("exitHashSecret").value;
      tollBoothContract.reportExitRoad(unhashedSecret,function(err, out) {
      if(!err) {
        console.log(out);
